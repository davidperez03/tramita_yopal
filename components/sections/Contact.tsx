  ...
  return (
    <section id="contacto" className="py-14 sm:py-20 bg-brand-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <FadeInStagger className="grid sm:grid-cols-2 gap-5 max-w-2xl mx-auto" stagger={0.1}>
          {/* WhatsApp */}
          <FadeInItem>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-center h-full">
              ...
              <a href={`tel:+${BUSINESS.whatsapp}`} className="text-white font-bold text-lg hover:text-wa transition-colors">{BUSINESS.phone}</a>
          ...
          <FadeInItem>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-center h-full">
              ...
              <p className="text-brand-200">{BUSINESS.hours.full}</p>
